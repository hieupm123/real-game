...
const ct_button = document.querySelector('.header_button');
const tron = document.querySelector('.tron');
const dap_an = document.querySelector('.dap_an');
const btn__resetss = document.getElementById('btn__reset_id');
let kq = 0;
var missed = 0;
